...
if ( curr_user !== null &&  curr_user !== "") {
    ...
    return (
        <div>
          <nav class="navbar navbar-expand-lg navbar-light" style={{backgroundColor:"rgb(16, 103, 117)",height:"1in"}}>
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link" style={{fontSize: "larger", color: "white",  fontWeight: "bolder"}} aria-current="page" href="/">Home</a>
                  </li>
                  <li class="nav-item">
